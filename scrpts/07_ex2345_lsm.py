...
input_file_BL = "inputs/lsm_input/ex5_BL.yaml"
input_file_UC = "inputs/lsm_input/ex5_UC.yaml"
...
plt.show()
fig, ax = plt.subplots()
UC.plot_wc(ax=ax, force=Thrust, delta_theta=delta_theta, color="red", label="UC")
plt.show()